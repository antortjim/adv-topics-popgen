...
h <- h_null
log(
  (h[1,] ^ 2) * (filter(input, marker == "1_846808", individual == ind, genotype == 2) %>% .$likelihood) +
  (2 * h[1,] * (1 - h[1,])) * (filter(input, marker == "1_846808", individual == ind, genotype == 1) %>% .$likelihood) +
  (1 - h[1,]) ^ 2 * (filter(input, marker == "1_846808", individual == ind, genotype == 0) %>% .$likelihood)
)
```
